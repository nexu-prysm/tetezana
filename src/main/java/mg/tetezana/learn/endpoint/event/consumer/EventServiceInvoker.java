package mg.tetezana.learn.endpoint.event.consumer;
...
import mg.tetezana.learn.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("mg.tetezana.learn.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "mg.tetezana.learn.service.event."
