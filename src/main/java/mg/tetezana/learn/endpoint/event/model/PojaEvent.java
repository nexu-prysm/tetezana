package mg.tetezana.learn.endpoint.event.model;

import static java.lang.Math.random;
import static mg.tetezana.learn.endpoint.event.EventStack.EVENT_STACK_1;
...
import mg.tetezana.learn.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "mg.tetezana.learn.event1";
    return "mg.tetezana.learn.event2";
  }
}
