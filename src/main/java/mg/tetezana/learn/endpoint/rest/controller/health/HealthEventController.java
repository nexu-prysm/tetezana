package mg.tetezana.learn.endpoint.rest.controller.health;

import static java.util.UUID.randomUUID;
import static mg.tetezana.learn.endpoint.rest.controller.health.PingController.KO;
import static mg.tetezana.learn.endpoint.rest.controller.health.PingController.OK;

import java.util.ArrayList;
import java.util.List;
import lombok.AllArgsConstructor;
import mg.tetezana.learn.PojaGenerated;
import mg.tetezana.learn.endpoint.event.EventProducer;
import mg.tetezana.learn.endpoint.event.model.DurablyFallibleUuidCreated1;
import mg.tetezana.learn.endpoint.event.model.DurablyFallibleUuidCreated2;
